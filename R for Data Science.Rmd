...
# dateset refine
not_cancelled <- flights %>% 
  filter(!is.na(de_delay),!is.na(arr_delay))
...
Other time we want to understand what makes obervations with missing values different to observations with recored values. For example, in ``
